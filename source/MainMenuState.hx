...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
       ...
       var logoJSON:LogoData = Json.parse(Paths.getTextFromFile('images/mainEditor.json'));
		...
		add(bg);
        back = new FlxSprite(logoJSON.backX, logoJSON.backY, Paths.image('back'));
		back.scale.set(logoJSON.backScaleX, logoJSON.backScaleY);
		add(back);
		var window:FlxSprite = new FlxSprite(logoJSON.windowX,logoJSON.windowY,Paths.image('window'));
